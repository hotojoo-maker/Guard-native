...
| **E. 装b 模块**（步数/定位/改零钱）               | 🟡   | 3   | E2 伪装定位 ✅ 装机 2026-06-07；E3 改余额 ✅ 装机 2026-07-09；E1 v2/v3      | §E  |
...
| E3  | 改余额显示       | ✅ 装机 2026-07-09：自定义金额 + 零钱通排除（显真实）+「我的零钱」页；改值收敛到 `WcPayMoneyLoadingView` 唯一显示层，详权威 §1b / `moduleE/FakeBalance.java` |
