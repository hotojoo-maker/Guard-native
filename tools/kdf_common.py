...
# OFFICIAL release keystore cert SHA-256 (signing/guard-native-official-release.jks,
# alias guardofficial). The runtime cert pushed via NativeBridge.setBindingMaterial()
...
CERT_SHA256 = bytes([
    ...
    0x47, 0x05, 0xc8, 0xa5, 0x0b, 0x03, 0xf4, 0x74,
    0xd6, 0xb6, 0x93, 0x81, 0x7a, 0xde, 0xcf, 0x36,
])
