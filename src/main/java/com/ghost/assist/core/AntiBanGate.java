...
/**
 * AntiBanGate — A2 防封授权闸（Route B · 本地完整性 + 时间闸）。
 *
 * <p>2026-06-29 从 {@link GuardRuntime} 拆出（行为零变更，devin/anti-ban-gate-extract）：
 * GuardRuntime 回归纯配方出口，A2 闸的本地完整性 + 时间闸逻辑全部落在本类。
 * 下方决策注释（A2 vs 隐私两套失败哲学 + D-020 决策摘要）为 SSOT 级原文保留。
 */
public final class AntiBanGate {
